...
import SpotifyLogo from '../assets/Spotify-Logo/Spotify_Logo_RGB_Green_Without_Name.png'
...
class Nav extends Component {
    ...
    render(){
        return(
            <Container>
                <Logo src={SpotifyLogo}></Logo>
                <Menu>
                    <MenuItem>
                        <Link activeClassName="active">
                            <TabIcon viewBox="0 0 1024 1024" width="100%" height="100%">
                    ...
                    <MenuItem>
                        <Link activeClassName="active">
                            <TabIcon xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 47.5 47.5" xmlSpace="preserve">
                                <g>
                    ...
                    <MenuItem>
                        <Link activeClassName="active">
                            <TabIcon version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 489.164 489.164" xmlSpace="preserve">
                    ...
                    <MenuItem>
                        <Link activeClassName="active">
                            <TabIcon xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" width="30px" height="29px" viewBox="0 0 510 510">
                                <g>
                                    <g id="history">
                    ...
                    <MenuItem>
                        <Link activeClassName="active">
                            <TabIcon xmlns="http://www.w3.org/2000/svg" version="1.1" x="0px" y="0px" viewBox="0 0 405.333 405.333" xmlSpace="preserve">
                                <g>
                ...
                <Github xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 438.549 438.549">
                <path
